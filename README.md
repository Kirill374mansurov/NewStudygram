...
**Foodgram** - это проект, сайт, который позволяет регистрироваться пользователям и публиковать свои рецепты в общий доступ. Также сайт позволяет подписываться на пользователей, добавлять рецепты в избранное и создавать удобный список покупок, который можно скачать и использовать по своему усмотрению.
